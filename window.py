...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('果蔬识别系统new')  # todo 修改系统名称
        # 模型初始化
        self.model = tf.keras.models.load_model("models/mobilenet_flowers2.h5")  # todo 修改模型名称
        self.to_predict_name = "images/tim9.jpeg"  # todo 修改初始图片，这个图片要放在images目录下
        self.class_names = ['叶子', '李子', '柠檬', '红苹果', '草莓', '西瓜', '西红柿', '青苹果', '香蕉', '黄芒果']  # todo 修改类名，这个数组在模型训练的开始会输出
        self.resize(900, 700)
        self.initUI()
    # 界面初始化，设置界面布局
    def initUI(self):
        ...
        label_super = QLabel("作者：zhoudi")  # todo 更换作者信息
